...
class DiffieHellman
{
    ...
    {
        if (null === $prime && null === $generator && 16 === $base) {
            $this->prime = gmp_init($this->randomPrime(), $base);
            $this->generator = gmp_init(2, 16);
        } else {
     ...
     * @return string
     */
    public function getPrime($base = 10)
    {
        return gmp_strval($this->prime, $base);
    }
     ...
     * @return int
     */
    public function getGenerator($base = 10)
    {
        return gmp_strval($this->generator, $base);
    }
     ...
     * @return string
     */
    public function getPrivateKey($base = 10)
    {
        return gmp_strval($this->privateKey, $base);
    }

    /**
     * $generator^$privateKey mod $prime
     *
     * @param int $base
     * @return string
     */
    ...
    {
        return gmp_strval($this->publicKey, $base);
    }
